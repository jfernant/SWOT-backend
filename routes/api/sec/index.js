  ...
  try {
    ...
    if (userLogged) {
      ...
      mailSender(
        ...
        '<h1>Restablecimiento de contraseña de SWOT</h1><p>Haga click en el enlace para restablecer su contraseña.</p><h2>UUID: '+uuid+'</h2><p><a href="http://localhost:3000/api/sec/passrecovery/{'+email+'}/{'+uuid+'}">Restablecer</></p>'
      );
